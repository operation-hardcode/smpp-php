...
final class SubmitSmTest extends TestCase
{
    public function testBinary(): void
    {
        $bytes = (string) (new SubmitSm(
            ...
            message: new Utf8Message('Hello, world!0!0', 2),
            serviceType: 'test',
            priority: 1,
        ...
        self::assertEquals(NPI::UNKNOWN, $frame->from->npi);
        ...
        self::assertEquals(0, $frame->message->coding()->value);
        self::assertEquals(2, $frame->message->id());
